...
int main(){
    ...
    cout << "This is a game to save the princess, defeat the Devil, rescue the princess, and become the bravest knight. Good luck everyone!" << endl;
    
    for(int i=0; i<1; i--){
        cout << "1. Purchase equipment and restore life." << endl;
        ...
        if(a == 1){
            ...
            while(1){
                cout << "Your information: (Life), (Attack), (Gold coins)" << endl;
                ...
                if(b == 1 && Goldcoins >= 10){
                    ...
                    while(1){
                        cout << "1. Stone sword —— 10 gold coins + 5" << endl;
                    ...
                    while(1){
                        cout << "1. Level 1 Life limit —— 40 gold coins + 10" << endl;
                    ...
                    while(1){
                        cout << "1. Level 1 Dodge —— 15 gold coins + 1" << endl;
                        cout << "2. Level 2 Dodge —— 150 gold coins + 10" << endl;
                        cout << "3. Level 3 Dodge ——300 gold coins + 20" << endl;
                        cout << "4. Level 4 Dodge ——1500 gold coins + 100" << endl;
                        cout << "0. Exit." <<  endl << "Enter: ";
                         cin >> c;
            ...
            while(1){
                cout << "1. Low-level Monster —— Life 20, Attack 10, Gold coins 50" << endl;
                ...
                if(b == 1){
                    ...
                    int Dodge1 = Dodge;
                    cout << "Low-level Monster —— Life 20, Attack 10, Gold coins 50" << endl << "Your attack power: " << Attack << " " << "Life: " << Life << endl << "Start! You VS Low-level Monster" << endl;
                    
                    while(Life > 0){
                        cout << "1. Attack 2. Dodge (" << Dodge1 << ") can make monster life -5" << endl << "Enter: ";
                         cin >> c;
                    ...
                    int Dodge1 = Dodge;
                    cout << "Intermediate Monster —— Life 100, Attack 25, Gold coins 100" << endl << "Your attack power: " << Attack << " " << "Life: " << Life << endl << "Start! You VS Intermediate Monster" << endl;
                    ...
                    int Dodge1 = Dodge;
                    cout << "Advanced Monster —— Life 400, Attack 10, Gold coins 200" << endl << "Your attack power: " << Attack << " " << "Life: " << Life << endl << "Start! You VS Advanced Monster" << endl;
                    ...
                    int Dodge1 = Dodge;
                    cout << "Ultimate Monster —— Life 1000, Attack 500, Gold coins 500" << endl << "Your attack power: " << Attack << " " << "Life: "<< Life << endl << "Start! You VS Ultimate Monster" << endl;
                    ...
                    int Dodge1 = Dodge;
                    cout << "Devil —— Life 5000, Attack 1000, Gold coins 1000，and pass the game!" << endl << "Your Attack: " << Attack << " " << "Life: " << Life << endl << "Start! You VS Devil" << endl;

                    
                    while(Life > 0){
                        cout << "1. Attack 2. Dodge (" << Dodge1 << ") can make Devil life -5" << endl << "Enter: ";
                         cin >> c;
